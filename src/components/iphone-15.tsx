...
export default function Iphone15Pro({
  ...
  return (
    <div className="relative w-full max-w-[433px] mx-auto" style={{ aspectRatio: `${width}/${height}` }}>
      <svg
      ...
      >
        ...
        <path
          ...
          className="fill-[#F5F5F5] stroke-[#E5E5E5] stroke-[0.5] dark:fill-[#1a1a1a] dark:stroke-[#404040]"
        />
